...
console.log(locationData.traffic);
console.log(locationData.toDo);
...
database.ref().on("child_added", function (childSnapshot) {
            ...
            var favoriteLocation = childSnapshot.val().searchText;
            var weather = childSnapshot.val().weather;
            var traffic = childSnapshot.val().trafficR;
            var toDo = childSnapshot.val().toDo;
            ...
            var newRow = $("<tr>").append(
                $("<td>").text(favoriteLocation)

                //add row to favoritesDiv
                $("favoritesTable > tbody").appent(newRow);
